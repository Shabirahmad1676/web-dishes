...
const Recommended = ({ recommended, favourite, toggleFavourite }) => {
  ...
  return (
    <div className="w-[1020px] bg-white rounded-lg shadow-lg p-6 text-black">
      ...
      {recommended.length > 0 ? (
        ...
        // <div className="flex gap-4 flex-wrap items-center justify-center mx-auto cursor-pointer mb-4">
      ...
      {show && selectedDish && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 ">
          <div className="bg-white rounded-lg shadow-lg p-8 w-96 text-black relative">
            {/* Close button */}
            <button
              onClick={closePopup}
              className="absolute z-40 top-2 right-2  cursor-pointer"
            >
              <RiCloseFill className='text-3xl font-bold'/>
            </button>
            ...
            {selectedDish.image && (
              <img
                ...
                className="w-full h-48 object-cover transition-all hover:scale-105 duration-300 delay-150 rounded-lg mb-4"
              />
            )}
